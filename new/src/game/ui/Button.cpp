...
namespace autochess::game
{
        ...
        const unsigned int characterSize)
    {
        ...
        shape_.setOutlineColor(ui::BorderStrong);

        label_.setFont(font);
        label_.setString(label);
        ui::setTextSize(label_, characterSize);
        label_.setFillColor(ui::TextPrimary);
        refreshVisual();
    }
    ...
    void Button::refreshVisual()
    {
        ...
        if (!enabled_)
        {
            shape_.setFillColor(ui::ControlDisabled);
            label_.setFillColor(ui::TextMuted);
        }
        else if (pressed_)
        {
            shape_.setFillColor(ui::ControlPressed);
            label_.setFillColor(ui::TextPrimary);
        }
        else if (hovered_)
        {
            shape_.setFillColor(ui::ControlHover);
            label_.setFillColor(ui::TextPrimary);
        }
        else
        {
            shape_.setFillColor(ui::Control);
            label_.setFillColor(ui::TextSecondary);
        }
        centerLabel();
    }
    ...
    void Button::centerLabel()
    {
        ...
        ui::centerText(label_, buttonBounds);
    }
}
